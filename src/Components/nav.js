...
import { Navimenu } from "/src/utils/header";
  ...
  return (
    <header className="header" id="header">
      <nav className="nav container">
        <Link
          href="https://www.linkedin.com/in/aaron-prellegera-5ba681211"
          target="_blank"
        ...
        <Link
          href="https://web.facebook.com/AerrowDevPH"
          target="_blank"
          className="home__social-icon"
        >
        ...
        <Link
          href="https://github.com/AerrowDev"
          target="_blank"
          className="home__social-icon"
        >
